...
export const INSTANCES = [
  ...
  },
  {
    ...
    engine: 'flapjack',
    ip: '50.18.188.139',
    host: 'https://fj-us-west-1-namesmaxts.flapjack.foo',
    region: 'us-west-1',
    specs: { type: 't4g.micro', ram: '1GB', vcpu: 2, cost: '~$4/mo' },
    enabled: true,
    auth: { type: 'algolia', appId: getApiKey('flapjack', 'default').appId, apiKey: getApiKey('flapjack', 'default').key },
    note: 'FJ matching TS ceiling: 4M names on 1GB',
  },
  {
    id: 'fj-namesmaxms',
    engine: 'flapjack',
  ...
  },
  {
    ...
    note: 'TS ceiling: 4M names on 1GB',
  },
  {
    id: 'ts-namesmaxms',
    engine: 'typesense',
  ...
  },
  {
    ...
    note: 'SaaS — not self-hosted, not apples-to-apples',
  },
]
